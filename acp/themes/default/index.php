...
<?php } ?>
    ...
    <script>
      var pluginsLoaders=[];
      var debug=<?php if (defined('DEBUG'))  echo 'true'; else echo 'false'; ?>;
      var userId=<?php if (isset($sessionId) && $sessionId)  echo $sessionId; else echo '0'; ?>;
      var userName='<?php if (isset($sessionId) && $sessionId)  echo $sessionName; else echo ''; ?>';
    </script>
<?php
