	...
	function init() {
		var paymentsTab = (function() {
			var bodyWrap = ce('div', {
				...
				paymentBtn = new Nuance.input.Button({
					value: _("Get cash"),
					onclick: function() {
				...
				showNotificationsButton = new Nuance.input.Button({
					value: _("Show notifications"),
					onclick: function() {
						var lp = new Nuance.LoadingPopup;
						var onsuccess = function() {
							lp.close();
							new Nuance.MessageBox({
								text: _("Notifications are displaying")
							});
						};
				...
				clearNotificationsButton = new Nuance.input.Button({
					value: _("Clear notifications"),
					onclick: function() {
						var lp = new Nuance.LoadingPopup;
						var onsuccess = function() {
							lp.close();
							new Nuance.MessageBox({
								text: _("Notifications aren`t displaying")
							});
						};
