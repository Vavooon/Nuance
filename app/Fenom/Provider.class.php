...
class Provider implements ProviderInterface
{
    ...
    public static function clean($path)
    {
        ...
        elseif (is_dir($path))
        {
            $iterator = iterator_to_array(
                    ...
                    new \RecursiveDirectoryIterator($path, \FilesystemIterator::KEY_AS_PATHNAME | \FilesystemIterator::CURRENT_AS_FILEINFO | \FilesystemIterator::SKIP_DOTS), \RecursiveIteratorIterator::CHILD_FIRST
                    )
            );
    ...
    public function getList($extension = "tpl")
    {
        ...
        $iterator = new \RecursiveIteratorIterator(
                new \RecursiveDirectoryIterator($this->_path, \FilesystemIterator::CURRENT_AS_FILEINFO | \FilesystemIterator::SKIP_DOTS), \RecursiveIteratorIterator::CHILD_FIRST
        );
