...
var Nuance =
        {
            ...
            input:
                    {
                        ...
                        TariffList: function (o)
                        {
                            ...
                            var self = this,
                                    disabled = false,
                                    addButton = new Nuance.input.Button({target: this.body, iconClass: 'add', onclick: function () {
            ...
            MessageBox: function (o)
            {
                ...
                var self = this;
                o.title = o.title || "&nbsp;";
                o.buttons = o.buttons || [{value: "OK", scope: this, submit: true, onclick: function () {
                            this.close()
                        }}];
                ...
                var targetopts =
                        {
                            buttons:
                                    [
                                        {value: _("Select all"), onclick: function () {
            ...
            FreeInetPopup: function (o)
            {
                ...
                o.buttons = [{onclick: okClick, value: _("Activate"), submit: true, iconClass: 'add'}, {onclick: function () {
                            self.close()
            ...
            DeletePopup: function (o)
            {
                ...
                o.buttons = [{onclick: okClick, value: _("Delete"), submit: true, iconClass: 'trash'}, {onclick: function () {
                            self.close()
                        }, value: _("Cancel"), iconClass: 'remove'}];
